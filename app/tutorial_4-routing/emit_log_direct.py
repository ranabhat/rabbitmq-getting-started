...
class Emitter():
    ...
    def return_random_routing_key(self):
        error = ["info", "warning", "error", "not queued"]
...
if __name__ == '__main__':
    while True:
        try:
            emitter_instance = Emitter(hostname='rabbitmq-getting-started_rabbitmq_1', queue='', routing_key='info', queue_name='', exchange='direct_logs', exchange_type='direct')
