...
class Consumer():
    ...
    def bind_queue(self):
        ...
        """
        severities = ["kern.*", "*.critical"] # ["anonymous.#"]
...
if __name__ == '__main__':
    while True:
        try:
            consumer_instance = Consumer(hostname='rabbitmq-getting-started_rabbitmq_1', queue='', routing_key='', queue_name='', exchange='topic_logs', exchange_type='topic')
